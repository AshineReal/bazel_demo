...
_SETTINGS = {
    "arm64-apple-ios-simulator App.app/App": {
        "c": "-iquote$(PROJECT_DIR) -iquote$(BAZEL_OUT)/ios_sim_arm64-dbg-ios-sim_arm64-min15.0-applebin_ios-ST-20b962f9c9ef/bin -fmodule-map-file=$(BAZEL_OUT)/ios_sim_arm64-dbg-ios-sim_arm64-min15.0-applebin_ios-ST-20b962f9c9ef/bin/libsignal/SignalFfi_modulemap/_/module.modulemap -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all",
        "s": [
            "$(BAZEL_OUT)/ios_sim_arm64-dbg-ios-sim_arm64-min15.0-applebin_ios-ST-20b962f9c9ef/bin/libsignal",
        ],
    },
}
